...
const SearchStackScreen = () => {
  return (
    <SearchStack.Navigator screenOptions={{ headerShown: false }}>
      <SearchStack.Screen name='Search Result List' component={SearchResultScreen} />
...
export default function App() {
  return (
    <NativeBaseProvider>
      <Header />
        <NavigationContainer>
        <Tab.Navigator screenOptions={{ headerShown: false }, {tabBarLabelStyle: {textTransform:'none'}}}>
